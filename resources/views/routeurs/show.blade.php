...
@php
    $header_buttons = '<a href="'.route('routeurs.index').'" class="btn-secondary" style="width: auto; padding: 0.65rem 1.2rem; border-radius: 2rem;"><i class="fas fa-arrow-left" style="margin-right: 0.4rem;"></i>Retour</a>';
@endphp
